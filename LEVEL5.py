...
LEVEL5.update()
#LEVEL--------------------------------------------------------------------------
Level = Label(LEVEL5, text="Current level: 5", bg="Black", fg="White", font=("Space Bd BT",15))
#LIFE POINTS
...
life_now = canvas.create_text(130, 65, text=" " + str(life), fill = "White", font=("Space Bd BT", 16))
